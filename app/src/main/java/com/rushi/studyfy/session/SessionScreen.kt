...
import com.rushi.studyfy.component.SubjectListBottomSheet
import com.rushi.studyfy.component.studySessionsList
import com.rushi.studyfy.ui.theme.Red
import com.rushi.studyfy.util.Constants.ACTION_SERVICE_CANCEL
import com.rushi.studyfy.util.Constants.ACTION_SERVICE_START
import com.rushi.studyfy.util.Constants.ACTION_SERVICE_STOP
...
@Destination(
	deepLinks = [
		DeepLink(
			...
			uriPattern = "studyfy://dashboard/session"
		)
	]
)
@Composable
